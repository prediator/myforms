...
insert  into `list`(`list_id`,`list_name`,`description`,`vrsn`) values (1,'my_list','my list','0.0.0.1'),(2,'my_movies','my Movies','0.0.0.1');
...
insert  into `list_val`(`list_val_id`,`list_id`,`list_val`,`vrsn`) values (9,1,'A',NULL),(10,1,'B',NULL),(11,1,'C',NULL),(12,2,'Kal Ho na Ho',NULL),(13,2,'Rang de basanti',NULL),(14,2,'Hitch',NULL),(15,2,'The Notebook',NULL);
...
insert  into `system_id`(`id`,`table_name`,`st_val`,`max_val`,`safe_val`,`next_val`) values (1,'tran_doc',1,2147483647,10,201),(2,'tran_fld',1,2147483647,10,231),(3,'tran_fld_list',1,2147483647,10,281),(4,'tran_rich_txt',1,2147483647,10,281);
...
insert  into `tran_fld_list`(`fld_list_id`,`fld_id`,`list_value`) values (241,194,'A'),(259,204,'A'),(260,206,'Rang de basanti'),(261,206,'Hitch'),(262,206,'The Notebook'),(263,230,'A'),(264,232,'Kal Ho na Ho'),(271,224,'A'),(272,226,'Rang de basanti');
...
insert  into `tran_rich_txt`(`rich_txt_id`,`fld_id`,`rich_txt`,`seq`) values (241,191,'<br>',0),(253,201,'dgsdgfdf<br>',0),(261,211,'<br>',0),(262,219,'<br>',0),(263,227,'<br>',0),(271,221,'dasdhagsdkjfhk hfdhsddklf<br>',0);
...
insert  into `users`(`userid`,`username`,`password`,`created_on`,`email_id`,`first_name`,`last_name`,`is_enabled`,`clnt_id`) values (2,'himanshu','himanshu','2012-02-02','hs@gmail.com','Himanshu','Saxena',1,1);
