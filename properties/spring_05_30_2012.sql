...
insert  into `doc_notes`(`DOC_NOTES_ID`,`DOC_ID`,`DOC_NOTES_DESC`,`CRTD_BY`,`CRTD_ON`) values (1,211,'ssdfsdfs',2,'2012-05-30'),(2,211,'sdfsdfsdfsdfsd',2,'2012-05-30');
...
insert  into `doc_rtxt`(`doc_rtxt_id`,`doc_rtxt`,`seq`,`rtext_id`) values (91,'<br>',0,71),(101,'Its a test movie',0,81);
...
insert  into `rtxt`(`rtext_id`,`doc_id`,`title`,`crt_by`,`crt_on`) values (71,211,'zxc','2','2012-05-20'),(81,231,'Movie Story','2','2012-05-30');
...
insert  into `system_id`(`id`,`table_name`,`st_val`,`max_val`,`safe_val`,`next_val`) values (1,'tran_doc',1,2147483647,10,241),(2,'tran_fld',1,2147483647,10,271),(3,'tran_fld_list',1,2147483647,10,341),(4,'tran_rich_txt',1,2147483647,10,321),(5,'upld_doc',1,2147483647,10,41),(6,'rtxt',1,2147483647,10,91),(7,'doc_rtxt',1,2147483647,10,111),(8,'tmpl',10000,2147483647,10,10120),(9,'fld',1000,2147483647,10,1110),(10,'doc_notes',1,2147483647,10,11),(11,'list',1,2147483647,10,222),(12,'list_val',1,2147483647,10,232),(13,'clnt_tmpl',1,2147483647,10,81);
...
insert  into `tran_fld_list`(`fld_list_id`,`fld_id`,`list_value`) values (241,194,'A'),(259,204,'A'),(260,206,'Rang de basanti'),(261,206,'Hitch'),(262,206,'The Notebook'),(263,230,'A'),(264,232,'Kal Ho na Ho'),(271,224,'A'),(272,226,'Rang de basanti'),(281,234,'A'),(282,236,'Rang de basanti'),(315,244,'B'),(316,246,'Rang de basanti'),(321,251,'Mohd Shariq'),(331,261,'Yarana');
...
insert  into `tran_rich_txt`(`rich_txt_id`,`fld_id`,`rich_txt`,`seq`) values (241,191,'<br>',0),(253,201,'dgsdgfdf<br>',0),(261,211,'<br>',0),(262,219,'<br>',0),(263,227,'<br>',0),(271,221,'dasdhagsdkjfhk hfdhsddklf<br>',0),(281,231,'<br>',0),(313,241,'dsfdsf<br>',0);
...
insert  into `user_roles`(`roleid`,`userid`) values (1,1),(2,2),(3,3),(4,4);
